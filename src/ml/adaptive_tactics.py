...
class AdaptiveTacticsManager:
    ...
    def __init__(self, config, database, logger=None):
        ...
        # Store current tactical adjustments
    ...
    def _adjust_symbol_trading(self, perf_30d: Dict) -> List[str]:
        ...
        try:
            from src.ml import TradeAnalyzer
            ...
            for symbol, stats in symbol_perf.items():
                ...
                # Pause if: enough trades + poor performance
                should_pause = (
                    trades >= 5 and  # Enough data
                    (win_rate < 30 or total_pnl < -50)  # Poor performance
                )
                
                # Resume if: decent recent performance
                should_resume = (
                    trades >= 3 and
                    win_rate >= 60 and
                    total_pnl > 0
    ...
    def _adjust_max_positions(self, advanced: Dict) -> List[str]:
        ...
        try:
            ...
            # High risk - reduce max positions
            ...
            # Elevated risk - slight reduction
            ...
            # Excellent risk management - can increase
